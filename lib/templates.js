  ...
  module.run(['$templateCache', function($templateCache) {
    ...
    $templateCache.put(
      ...
      '<div>' +
        '<div ng-switch on="data.state">' +
          ...
          '<div ng-switch-default cr-model-form schema="schema" ng-model="model" valid="data.valid" path="{{path}}"></div>' +
        '</div>' +
    ...
    $templateCache.put(
      ...
      '<div>' +
        ...
        '<p>Valid: {{ modelForm.$valid }}</p>' +
        '<p>Pristine: {{ modelForm.$pristine }}</p>' +
        '<p>Errors: {{ modelForm.$error }}</p>' +
