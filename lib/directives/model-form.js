(function() {
  ...
  module.directive('crModelForm', function($compile, $timeout, crBuild, crSchema) {
    return {
      scope: {
        schema: '=',
        model: '=?',
      ...
      link: function(scope, elem, attrs) {
        ...
        scope.$watch('schema', function(newValue, oldValue) {
          ...
          if (!scope.model) {
            console.log('watch schema, create default model');
        ...
        scope.$watch('model', function(newValue) {
          ...
          if (!newValue) {
            console.log('watch model, create default model');
