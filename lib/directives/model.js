(function() {
  ...
  module.controller('crModelCtrl', function($scope, crResources, crSchema, crCommon) {
    ...
    this.save = function() {
      ...
      return this._resource.save($scope.model, fs).then(function(doc) {
        $scope.model = doc;
  ...
  module.directive('crModelForm', function($compile, crBuild, crSchema, crCommon) {
    return {
      ...
      link: function(scope, elem) {
        ...
        scope.$watch('modelForm.$valid', function(newValue) {
